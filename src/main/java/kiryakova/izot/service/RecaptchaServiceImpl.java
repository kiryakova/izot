...
public class RecaptchaServiceImpl implements RecaptchaService {
    ...
    public String verifyRecaptcha(String userIpAddress, String gRecaptchaResponse) {
        ...
        ResponseEntity<Map> recaptchaVerifyResponse =
                ...
                .postForEntity(GOOGLE_RECAPTCHA_VERIFY_URL + "?secret={secret}&response={response}&remoteip={remoteip}", recaptchaVerifyRequestBody, Map.class, recaptchaVerifyRequestBody);
